...
/**
 * This class creates an immutable hash set using an associated array.
 *
 * @access public
 * @class
 * @package Common
...
class HashSet extends Core\AbstractObject implements Common\ISet
{
    ...
    {
        return (($object !== null) && ($object instanceof Common\HashSet) && ((string)serialize($object->elements) == (string)serialize($this->elements)));
    }
     ...
     *
     * @access public
     * @return string the key on success or null on failure
     */
    public function key()
    {
