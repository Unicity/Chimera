...
class LinkedList extends Core\AbstractObject implements Common\IList
{
    ...
    public function getValue($index)
    {
        if (is_integer($index)) {
            ...
            throw new Throwable\OutOfBounds\Exception('Unable to get element. Invalid index specified', [':index' => $index]);
        }

        throw new Throwable\InvalidArgument\Exception('Unable to get element. :type is of the wrong data type.', [':type' => gettype($index)]);
    }
