...
class Charset extends Core\AbstractObject
{
    ...
    /**
     * This constant defines the encoding for CP932.
     *
     * @access public
     * @const string
     */
    public const CP932_ENCODING = 'CP932';
        ...
        if (is_string($string) && ($string != '')) {
            ...
            if (strcasecmp($target_encoding, static::UTF_8_ENCODING) == 0) { // http://stackoverflow.com/questions/1523460/ensuring-valid-utf-8-in-php
                ...
                */
                ...
                $blacklist = ['%E0%B8%BA', '%E2%80%8B']; // known non-printable/hidden characters
                $replacement = '';
                ...
                $blacklist = ['%E2%94%9C', '%E2%94%90']; // known printable/visible characters
                $replacement = ' ';
