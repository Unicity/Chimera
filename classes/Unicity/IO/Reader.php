...
abstract class Reader extends Core\AbstractObject implements Core\IDisposable
{
     ...
     *                resource
     */
    abstract public function readBlock(int $offset, int $length): ?string;
     ...
     *              resource
     */
    abstract public function readChar($position = null, bool $advance = true): ?string;
     ...
     */
    abstract public function seek($position): void;
     ...
     */
    abstract public function skip($n): void;
