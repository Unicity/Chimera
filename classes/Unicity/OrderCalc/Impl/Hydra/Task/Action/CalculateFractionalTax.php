...
namespace Unicity\OrderCalc\Impl\Hydra\Task\Action {
	...
	class CalculateFractionalTax extends BT\Task\Action {
		...
		public function process(BT\Engine $engine, string $entityId) : int {
			...
			$numerator = Core\Convert::toDouble($this->policy->getValue('numerator'));
			$denominator = Core\Convert::toDouble($this->policy->getValue('denominator'));

			$tax_rate = $numerator / $denominator;
