...
namespace Unicity\OrderCalc\Impl\Hydra\Task\Action {
	...
	class RoundFreightToNearest5Cents extends BT\Task\Action {
		...
		public function process(BT\Engine $engine, string $entityId) {
			...
			$order->terms->freight->amount = OrderCalc\Engine\Service\Money::roundToNearest5Cents($order->terms->freight->amount, $order->currency);
