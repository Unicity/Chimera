...
namespace Unicity\OrderCalc\Impl\Hydra\Task\Guard {
	...
	class IsShippingFromLocation extends BT\Task\Guard {
		...
		public function process(BT\Engine $engine, string $entityId) : int {
			...
			$locations = $this->policy->getValue('locations');

			if ($locations->hasValue($order->shippingMethod->location)) {
