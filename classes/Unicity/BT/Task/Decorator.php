...
abstract class Decorator extends BT\Task\Composite
{
    ...
    public function __get($name)
    {
        if ($name == 'task') {
            ...
            throw new Throwable\InvalidProperty\Exception('Unable to get property. Excepted a valid property name, but got ":name" instead.', [':name' => $name]);
        }
    }
    ...
    public function __set($name, $value)
    {
        if ($name == 'task') {
            ...
            throw new Throwable\InvalidProperty\Exception('Unable to set property. Excepted a valid property name, but got ":name" instead.', [':name' => $name]);
        }
    }
