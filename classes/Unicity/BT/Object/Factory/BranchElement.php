...
namespace Unicity\BT\Object\Factory {
	...
	class BranchElement extends Spring\Object\Factory {
		...
		public function getObject(Spring\Object\Parser $parser, \SimpleXMLElement $element) {
			...
			if (!($object instanceof BT\Task\Branch)) {
				throw new Throwable\Parse\Exception('Invalid type defined. Expected a task branch, but got an element of type ":type" instead.', array(':type' => $type));
			}
