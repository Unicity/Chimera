...
class LoggerElement extends Spring\Object\Factory
{
    /**
    ...
    public function getObject(Spring\Object\Parser $parser, \SimpleXMLElement $element)
    {
        ...
        if (!($object instanceof BT\Task\Logger)) {
            throw new Throwable\Parse\Exception('Invalid type defined. Expected a task logger, but got an element of type ":type" instead.', [':type' => $type]);
        }
