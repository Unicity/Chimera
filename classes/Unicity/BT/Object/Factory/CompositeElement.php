...
namespace Unicity\BT\Object\Factory {
	...
	class CompositeElement extends Spring\Object\Factory {
		...
		public function getObject(Spring\Object\Parser $parser, \SimpleXMLElement $element) {
			...
			if (!($object instanceof BT\Task\Composite)) {
				throw new Throwable\Parse\Exception('Invalid type defined. Expected a task composite, but got an element of type ":type" instead.', array(':type' => $type));
			}
