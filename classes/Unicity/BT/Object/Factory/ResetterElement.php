...
namespace Unicity\BT\Object\Factory {
	...
	class ResetterElement extends Spring\Object\Factory {
		...
		public function getObject(Spring\Object\Parser $parser, \SimpleXMLElement $element) {
			...
			if (!($object instanceof BT\Task\Resetter)) {
				throw new Throwable\Parse\Exception('Invalid type defined. Expected a task resetter, but got an element of type ":type" instead.', array(':type' => $type));
			}
