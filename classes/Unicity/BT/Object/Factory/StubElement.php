...
class StubElement extends Spring\Object\Factory
{
    /**
    ...
    public function getObject(Spring\Object\Parser $parser, \SimpleXMLElement $element)
    {
        ...
        if (!($object instanceof BT\Task\Stub)) {
            throw new Throwable\Parse\Exception('Invalid type defined. Expected a task stub, but got an element of type ":type" instead.', [':type' => $type]);
        }
