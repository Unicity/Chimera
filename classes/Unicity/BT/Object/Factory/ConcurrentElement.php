...
namespace Unicity\BT\Object\Factory {
	...
	class ConcurrentElement extends Spring\Object\Factory {
		...
		public function getObject(Spring\Object\Parser $parser, \SimpleXMLElement $element) {
			...
			if (!($object instanceof BT\Task\Concurrent)) {
				throw new Throwable\Parse\Exception('Invalid type defined. Expected a task concurrent, but got an element of type ":type" instead.', array(':type' => $type));
			}
