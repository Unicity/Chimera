...
namespace Unicity\BT\Object\Factory {
	...
	class SequenceElement extends Spring\Object\Factory {
		...
		public function getObject(Spring\Object\Parser $parser, \SimpleXMLElement $element) {
			...
			if (!($object instanceof BT\Task\Sequence)) {
				throw new Throwable\Parse\Exception('Invalid type defined. Expected a task sequence, but got an element of type ":type" instead.', array(':type' => $type));
			}
