...
namespace Unicity\EVT\EventWriter {
	...
	class File extends EVT\EventWriter {
		 ...
		 */
		public function __construct(string $directory, array $metadata = array()) {
			...
			if (!is_dir($directory) || !is_writable($directory)) {
				throw new Throwable\FileNotFound\Exception('Directory :directory must be writable', array(':directory' => $directory));
			}
