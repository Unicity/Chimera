...
class ArrayList extends Common\Mutable\ArrayList implements ORM\IModel
{
    ...
    {
        return [$this->schema, $this->case_sensitive];
    }
    ...
    public function setValue($index, $value)
    {
        ...
        throw new Throwable\InvalidArgument\Exception('Unable to set element. Expected an integer, but got ":index" of type ":type".', [':index' => $index, ':type' => Core\DataType::info($index)->type]);
    }
