...
class IsNotEqualToField extends VLD\Module
{
    public function process(BT\Entity $entity, array $paths): VLD\Parser\Feedback
    {
        ...
        foreach ($paths as $path) {
            ...
            if ($v2 === $v1) {
                $feedback->addViolation(VLD\RuleType::mismatch(), VLD\Code::VALUE_IS_NE_FIELD, [$path], ['{{ field }}' => VLD\Parser\Feedback::formatKey($field)]);
            }
        }
