 ...
 * @package VLD
 */
class BlockVariable extends Core\AbstractObject implements Lexer\Scanner\ITokenRule
{
    /**
    ...
    public function process(IO\Reader $reader): ?Lexer\Scanner\Tuple
    {
        ...
        if (($char !== null) && ($char === '^')) {
            ...
            if (($next !== null) && preg_match('/^[_a-z0-9]$/i', $next)) {
                ...
                $tuple = new Lexer\Scanner\Tuple(VLD\Scanner\TokenType::variable_block(), new Common\StringRef($token), $index);
