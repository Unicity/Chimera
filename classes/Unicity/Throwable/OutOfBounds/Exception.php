...
namespace Unicity\Throwable\OutOfBounds {

	use \Unicity\Core;
	use \Unicity\Throwable;

	/**
	 * This class represents an Out-Of-Bounds Exception.
	 *
	 * @access public
	 * @class
	 * @package Throwable
	 */
	class Exception extends \OutOfBoundsException implements Core\IObject {
		...
		public function __equals($object) {
			return (($object !== null) && ($object instanceof Throwable\OutOfBounds\Exception) && ((string) serialize($object) == (string) serialize($this)));
		}
