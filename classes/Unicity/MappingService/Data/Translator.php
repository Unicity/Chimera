...
namespace Unicity\MappingService\Data {
	...
	abstract class Translator extends Core\Object {
		...
		public function __get($name) {
			if (!in_array($name, array('metadata', 'models'))) {
				throw new Throwable\InvalidProperty\Exception('Unable to get property. Expected a valid name, but got ":name".', array(':name' => $name));
			}
			return $this->$name;
		}
