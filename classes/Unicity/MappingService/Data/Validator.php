...
class Validator extends Core\AbstractObject
{
     ...
     */
    final public static function execute(string $script, Common\HashMap $input): Common\IMap
    {
        ...
        if (is_null($file)) {
            throw new Throwable\FileNotFound\Exception('Unable to locate file for ":script".', [':script' => $script]);
        }
