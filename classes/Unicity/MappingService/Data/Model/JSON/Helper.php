...
class Helper extends Core\AbstractObject
{
    ...
    public static function resolveArrayValue($value, $definition, $case_sensitive)
    {
        if (Core\Data\ToolKit::isUnset($value)) {
            if (isset($definition['required']) && $definition['required']) {
                throw new Throwable\Runtime\Exception('Invalid value defined. Expected a value that is an array, but got ":type".', [':type' => Core\DataType::info($value)->type]);
            }
        ...
        if (!($value instanceof MappingService\Data\Model\JSON\ArrayList)) {
            if (is_object($value) || is_array($value)) {
                ...
                throw new Throwable\Runtime\Exception('Invalid value defined. Expected an array of type ":type0", but got a value of type ":type1".', [':type0' => '\\Unicity\\MappingService\\Data\\Model\\JSON\\ArrayList', ':type1' => Core\DataType::info($value)->type]);
            }
        }
    ...
    public static function resolveObjectValue($value, $definition, $case_sensitive)
    {
        if (Core\Data\ToolKit::isUnset($value)) {
            if (isset($definition['required']) && $definition['required']) {
                throw new Throwable\Runtime\Exception('Invalid value defined. Expected a value that is an object, but got :type.', [':type' => Core\DataType::info($value)->type]);
            }
        ...
        if (!($value instanceof MappingService\Data\Model\JSON\HashMap)) {
            if (is_object($value) || is_array($value)) {
                ...
                throw new Throwable\Runtime\Exception('Invalid value defined. Expected an object of type ":type0", but got a value of type ":type1".', [':type0' => '\\Unicity\\MappingService\\Data\\Model\\JSON\\HashMap', ':type1' => Core\DataType::info($value)->type]);
            }
        }
